...
export const ticket = [
  ...
  // Ticket id : 1
  {
    ...
    fechaLimiteResolucion: new Date("2025-10-27T08:00:00Z"),  // 28:00 hora de CR (1440 min = 24 horas)
    respondidoAt: null,
    resueltoAt: null,
    cerradoAt: null,
    cerradoPorId: null,
  ...
  // Ticket id : 2
  {
    ...
    fechaLimiteRespuesta: new Date("2025-10-28T09:00:00Z"),  // 03:00 hora de CR (60 min = 1 hora)
    fechaLimiteResolucion: new Date("2025-10-28T14:00:00Z"), // 08:00 hora de CR (360 min = 6 horas)
    respondidoAt: new Date("2025-10-28T08:30:00Z"),          // dentro del plazo = cumplió respuesta
    resueltoAt: null,
    cerradoAt: null,
    cerradoPorId: null,
  ...
  // Ticket id : 4
  {
    ...
    respondidoAt: new Date("2025-10-29T08:30:00Z"),           // dentro del plazo
  ...
  // Ticket id : 5
  {
    ...
    categoriaId: 3,
    usuarioAsignadoId: 5,
    creadoAt: new Date("2025-10-30T09:00:00Z"),               // 03:00 hora de CR
    fechaLimiteRespuesta: new Date("2025-10-30T10:00:00Z"),   // 04:00 hora de CR (60 min = 1 hora)
    fechaLimiteResolucion: new Date("2025-10-30T15:00:00Z"),  // 09:00 hora de CR (360 min = 6 horas)

    respondidoAt: new Date("2025-10-30T09:10:00Z"),           // 03:10 hora de CR -> dentro del plazo
    resueltoAt: new Date("2025-10-30T14:00:00Z"),             // 08:00 hora de CR -> dentro del plazo
    cerradoAt: new Date("2025-10-30T15:30:00Z"),              // 09:30 hora de CR -> fuera del plazo
    cerradoPorId: 1,
    cumplioRespuesta: true,
    cumplioResolucion: true,
  },
  ...
  // Ticket id : 6
  {
    ...
    categoriaId: 2,
    usuarioAsignadoId: null,
    creadoAt: new Date("2025-10-31T17:29:21Z"),              // 11:29 hora de CR
    fechaLimiteRespuesta: new Date("2025-10-31T18:29:21Z"),   // 12:29 hora de CR (60 min = 1 hora)
    fechaLimiteResolucion: new Date("2025-10-31T23:29:21Z"),  // 17:29 hora de CR (360 min = 6 horas)
    respondidoAt: null,
    resueltoAt: null,
    cerradoAt: null,
    cerradoPorId: null,
  ...
  // Ticket id : 7
  {
    ...
    categoriaId: 4,
    usuarioAsignadoId: 5,
    creadoAt: new Date("2025-11-01T10:00:00Z"),
    fechaLimiteRespuesta: new Date("2025-11-01T11:00:00Z"),   // 05:00 hora de CR (60 min = 1 hora)
    fechaLimiteResolucion: new Date("2025-11-01T22:00:00Z"),  // 16:00 hora de CR (720 min = 12 horas)
    respondidoAt: null,
    resueltoAt: null,
    cerradoAt: null,
    cerradoPorId: null,
